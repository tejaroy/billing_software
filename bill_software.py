...
class Bill_App:
    ...
    def save_bill(self):
        ...
        if op > 0:
            ...
            f1 = open("C:\\Users\\ADMIN\\PycharmProjects\\FS_Python_Batch_16\\bills\\"+str(self.bill_no.get())+".txt", "w")
    ...
    def find_bill(self):
        present = "no"
        for i in os.listdir("C:\\Users\\ADMIN\\PycharmProjects\\FS_Python_Batch_16\\bills\\"):
            if i.split('.')[0] == self.search_bill.get():
                f1 = open(f"C:\\Users\\ADMIN\\PycharmProjects\\FS_Python_Batch_16\\bills\\{i}", "r")
                self.txtarea.delete("1.0", END)
                for d in f1:
